...
```
![img](/img/2022-xyb-SU-Writeup/1.png)
生成后就可以开始使用graphql注入，一步步注入获取密码为13Rj2x7VgjCLHIOZSGX0
![img](/img/2022-xyb-SU-Writeup/2.png)
登录后查看flag

## ezjava
![img](/img/2022-xyb-SU-Writeup/3.png)
cc4可以直接打，但是不出网，所以得打一个tomcat通用回显
![img](/img/2022-xyb-SU-Writeup/4.png)

## Rustwaf
先读src，然后使用/readfile 传入/flag可以进一步看到源码
![img](/img/2022-xyb-SU-Writeup/5.png)
...
![image](/img/2022-xyb-SU-Writeup/10.png)

由于本题没开`PIE`保护，且`got`表可写：

![image](/img/2022-xyb-SU-Writeup/11.png)
...
![image](/img/2022-xyb-SU-Writeup/12.png)
...
```
![image](/img/2022-xyb-SU-Writeup/13.png)
...
![img](/img/2022-xyb-SU-Writeup/6.png)
...
## sandboxheap
沙箱分析
![img](/img/2022-xyb-SU-Writeup/7.png)
...
漏洞所在：
![img](/img/2022-xyb-SU-Writeup/8.png)
...
flag3直接是明文
![img](/img/2022-xyb-SU-Writeup/9.png)
