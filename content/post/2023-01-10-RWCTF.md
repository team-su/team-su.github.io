...
## Evil MySQL Server
MySQL服务端读取客户端文件漏洞
![](/img/2023-01-10-RWCTF/4.png)

## Yummy Api
YApi NoSQL注入导致远程命令执行漏洞
![](/img/2023-01-10-RWCTF/5.png)

## Be-a-Famicom-Hacker
`https://tieba.baidu.com/p/20384367?pn=1`
![](/img/2023-01-10-RWCTF/6.png)
玩游戏通关到最后按这两个键出flag

![](/img/2023-01-10-RWCTF/7.png)
上上下下左右左右ba
