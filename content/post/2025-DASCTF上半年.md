...
![img](/img/2025-DASCTF上半年/QQ20250621-212945.jpg)
...
![img](/img/2025-DASCTF上半年/fb9dd69d-4af3-469c-adad-31e922d4d2ac.png)
...
![img](/img/2025-DASCTF上半年/01279d99-7aaa-4fbe-b3f8-8c406ecf39e4.png)

猜测是neta提取的有问题，估计是做限制了，故转手搓：

众所周知蓝牙传输的协议一般是obex，所以过滤一下，可以发现这里明显是传了一个jpg的

![img](/img/2025-DASCTF上半年/33618614-7e91-4c5f-a7d4-055098b8a52f.png)
...
![img](/img/2025-DASCTF上半年/fd147174-057a-4b4e-b7c2-c19fad4ce93a.png)

全部提取出来，根据010的模板会发现内容是不全的

![img](/img/2025-DASCTF上半年/7a0a5ddc-f7e4-4136-a343-baa4fbe15438.png)

回到wireshark分析一下，会发现在最后面还漏了一个流量数据，将他单独提取出来拼上后即可修复压缩包

![img](/img/2025-DASCTF上半年/604fb2fb-2908-4fa7-84b1-5d95d5a7ee69.png)

打开后它提示我们密码是蓝牙传输的目标电脑名字

![img](/img/2025-DASCTF上半年/a0b85729-7f2a-4fb2-9920-5a9135aa631a.png)

在wireshark的无线中找到蓝牙设备，然后简单遍历一下就知道密码是`INFERNITYのPC`

![img](/img/2025-DASCTF上半年/6b95853a-1064-4cec-b6e9-49d61a22f66d.png)

解压得到一张奇怪的png图，猜测是lsb隐写，stegsolve分析找到flag

![img](/img/2025-DASCTF上半年/6135bd3f-db5e-436d-87cb-603e8139a4c1.png)

## Webshell Plus

根据题意易得webshell流量，那么就看是哪种常见的，简单分析可以发现传了个shell.php

![img](/img/2025-DASCTF上半年/26764c97-ca32-4fdf-8663-1181593712d9.png)
...
![1](/img/2025-DASCTF上半年/3c888a6d-f36e-43ef-b53a-85a8d18181de.png)
...
![img](/img/2025-DASCTF上半年/2e926d28-f8fc-4254-957f-be28978ff2f6.png)

用这个在线网站https://www.ssleye.com/ssltool/pub_asysi.html  解出n，然后用yafu爆破得到p和q，接着按照文章操作得出私钥文件即可

![img](/img/2025-DASCTF上半年/d78b73c2-3401-40e4-bc31-0384887b9250.png)
...
![img](/img/2025-DASCTF上半年/d10d1d52-b2ec-4fd6-81c9-4785a7028753.png)

![img](/img/2025-DASCTF上半年/8e853000-f963-4e15-8f83-b8a3275b16d4.png)

![img](/img/2025-DASCTF上半年/89855f6a-481a-427e-81ad-63ec6883d3f2.png)
...
![img](/img/2025-DASCTF上半年/8312ebfa-6b66-4a8e-a565-57b42f3575ca.png)

访问一个不存在的文件时，会调用这个函数 存在格式化字符串漏洞

![img](/img/2025-DASCTF上半年/90840edc-856b-4c9c-b041-35f1cc01a6c0.png)
...
![img](/img/2025-DASCTF上半年/6b02f1ab-2046-415d-907b-1c4bfa227df5.png)
...
![img](/img/2025-DASCTF上半年/18193d0b-9fd9-4ec0-97e1-a2cd1c284fc3.png)

猜测是真正的密文，尝试解密

![img](/img/2025-DASCTF上半年/52464938-efca-4ecb-926e-459e1644ac83.png)
...
![img](/img/2025-DASCTF上半年/e96f1a83-4c5a-4528-ae97-133dfd00956b.png)
...
![img](/img/2025-DASCTF上半年/ade9d6f8-05b9-45bf-95f7-111d4196fdfb.png)
...
![img](/img/2025-DASCTF上半年/3b0f6c59-984f-48fa-9cb7-f8d25f7482c1.png)

44306E5175317830746535616E636830——D0nQu1x0te5anch0

![img](/img/2025-DASCTF上半年/9612a3b1-cd10-43a3-a19c-77e48c3c8c5e.png)
