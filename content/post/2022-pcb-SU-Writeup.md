...
![](/img/2022-pcb-SU-Writeup/image1.png)

![](/img/2022-pcb-SU-Writeup/image2.png)

### Ez_java

存在反序列化黑名单

![](/img/2022-pcb-SU-Writeup/image3.png)

但是存在cb依赖

![1](/img/2022-pcb-SU-Writeup/image4.png)
...
![](/img/2022-pcb-SU-Writeup/image5.png)

![](/img/2022-pcb-SU-Writeup/image6.png)
...
![](/img/2022-pcb-SU-Writeup/image7.png)
...
![](/img/2022-pcb-SU-Writeup/image10.png)
...
![](/img/2022-pcb-SU-Writeup/image11.png)
...
![](/img/2022-pcb-SU-Writeup/image12.png)

解法2：

构造一个畸形的压缩包或者解压到一半损坏的压缩包即可。

![](/img/2022-pcb-SU-Writeup/image13.png)

![](/img/2022-pcb-SU-Writeup/image14.png)

![](/img/2022-pcb-SU-Writeup/image15.png)
...
![](/img/2022-pcb-SU-Writeup/image16.png)
...
![](/img/2022-pcb-SU-Writeup/image17.png)

得到flag.txt,发现是每行是一个点的坐标

使用gnuplot画图

![](/img/2022-pcb-SU-Writeup/image18.png)
...
![](/img/2022-pcb-SU-Writeup/image19.png)

简单的提取处理一下,得到三张图片

![](/img/2022-pcb-SU-Writeup/image20.png)

根据题目名称water,猜测是盲水印

![](/img/2022-pcb-SU-Writeup/image21.png)

得到压缩包密码:ZC4#QaWbW

得到一张奇怪的图片,010打开发现crc报错,而且根据图片内容很容易发现是高宽被修改

![](/img/2022-pcb-SU-Writeup/image22.png)
...
![](/img/2022-pcb-SU-Writeup/image23.png)

修改高宽后得到flag

![](/img/2022-pcb-SU-Writeup/image24.png)
...
![](/img/2022-pcb-SU-Writeup/image25.png)

搜索这种表的特征，找到了一串数据，且带有seccess，符合题目语境

![](/img/2022-pcb-SU-Writeup/image26.png)
...
![](/img/2022-pcb-SU-Writeup/image27.png)

把zip文件导出来，其实里边就是注册表的备份文件:

![](/img/2022-pcb-SU-Writeup/image28.png)
...
![](/img/2022-pcb-SU-Writeup/image29.png)
